...
console.log("\n── Y. v2.103.3: NADWYŻKA PASKA vs SONDY W LOCIE (fałszywy alarm 21:34 25.08) ──");
{
  ...
  eq("nadwyżka paska liczona przez barExcessDecision (v2.104.0; pełny test: test-nadwyzka.js)", /barExcessDecision\(\{ barForeign, barCached, attacks, spies, spiesInFlight, spyMaxEta, barCountsProbes, candidateAt, excessSince, now \}\)/.test(src), true);
