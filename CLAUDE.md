...
| plik | uni | stan | uwaga |
|---|---|---|---|
| `ogamex-3.user.js` | **genesis.ogamex.net** | **AKTYWNY ROZWÓJ** (v3.99.3, ~6,6k linii) | tu idzie cała nowa praca; profil gracza: ODKRYWCA; gra chodzi w **Chrome** (od 09.09) |
...
## Historia i kontekst
- **`HANDOFF-2026-09-14.md` — CZYTAĆ NAJPIERW** (sekcja 8 = sesja popołudniowa 14.09 na Windows, v3.96.0: Sekcje 9–17 = 14/16.09 (przenosiny, noc, v3.96.1–3.99.2; 17 = fala domykająca bierze cały hangar z formularza + podejrzenie drugiego bota; 15 = fork wysyła mniej, niż wpisano, ekspedycje bez sond i LC; 16 = osłona przełączników panelu, lądowanie w trakcie wysyłki); odczyt stanu z Chrome na Macu: `tools/mac_chrome_state.py`.
